								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<div class="padding-10">
											<br>
											<div class="pull-left">Nome #
												<strong><?php echo $processo['name']; ?></strong>
				
												<address>
													<br>Email : 
													<strong><?php echo $processo['email']; ?></strong>
													<br>
													Cpf: <?php echo $processo['cpf']; ?>
													<br>
													Rg: <?php echo $processo['rg']; ?>
													<br>
													<abbr title="Phone">Telefone:</abbr> <?php echo $processo['telefone']; ?>
												</address>
											</div>
											<div class="pull-right">
												<h1 class="font-400"><?php echo $processo['name']; ?></h1>
											</div>
												...
												<div class="col-sm-3">
													<div>
														<div>
															...
															<span class="pull-right"> <?php echo $processo['name']; ?> </span>
														</div>
													...
													<div>
														<div class="font-md">
															...
															<span class="pull-right"> <i class="fa fa-calendar"></i> <?php echo $processo['data_nascimento']; ?> </span>
														</div>
