			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="/adm/img/avatars/sunny.png" alt="me" class="online" /> 
						<span>
							joseph 
						</span>
			...
			<nav>
				...
				<ul>
					...
					<li class="active open">
						<a href="#"><i class="fa fa-lg fa-fw fa-windows"></i> <span class="menu-item-parent">Benjamin</span></a>
						<ul style="display:block;">
							<li>
								<a href="/admin/list/produtos" target="_top">Produtos</a>
							</li>
							<li>
								<a href="/admin/listagem/user" target="_top">Usuarios</a>
							</li>
							<li>
								<a href="/admin/list/lojas" target="_top">Lojas</a>
							</li>

							<li>
								<a href="/admin/list/pagamentos" target="_top">Pagamentos</a>
							</li>
