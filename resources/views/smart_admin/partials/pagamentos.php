										...
										<table id="datatable_col_reorder" class="table table-striped table-bordered table-hover" width="100%">
											<thead>
												<tr>
													...
													<th data-hide="phone">Id Pagamento</th>
													<th>Ações</th>
												</tr>
											</thead>
											<tbody>
												...
												<tr ng-repeat="usuario in todoList.listagem">
													...
													<td><a href="/admin/<?php echo $entidade;?>/{{usuario.id}}">{{usuario.name}}@loja {{usuario.shop}} </a></td>
									
													<td>{{usuario.total}}</td>
													<td>{{todoList.tipos_pagamentos[usuario.type]}}</td>
													<td>{{usuario.tid}}</td>
